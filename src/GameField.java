...
class Surface extends JPanel implements ActionListener{
    ...
    public Surface(GameStage gameStage) throws FileNotFoundException {
        ...
        try {
            File text = new File("C:\\Users\\ASUS\\Desktop\\gam\\The Game\\src\\Enemy.txt");
    ...
    private void doDrawing(Graphics g) {
        ...
        g2d.drawString("MONEY: " + REWARD, 980, 48);
        ...
        try {
            if (type != 0) {
                ...
                if (type != 0) if (count == countSpawn) {
                    count = 0;
                    if (type == 1) enemies.add(new NormalEnemy(new Point(gameStage.getSpawer().getPoint()), new Point(gameStage.getRoads()[1].getPoint())));
                    else if (type == 2) enemies.add(new SmallerEnemy(new Point(gameStage.getSpawer().getPoint()), new Point(gameStage.getRoads()[1].getPoint())));
                    else if (type == 3) enemies.add(new TankerEnemy(new Point(gameStage.getSpawer().getPoint()), new Point(gameStage.getRoads()[1].getPoint())));
                    else if (type == 4) enemies.add(new BossEnemy(new Point(gameStage.getSpawer().getPoint()), new Point(gameStage.getRoads()[1].getPoint())));
                    num--;
                }
            }
            else {
        ...
        if(HP<=0)   {
            ...
            Image endGame = loader.getImage("C:\\Users\\ASUS\\Desktop\\gam\\The Game\\game_over.png");
...
public class GameField extends JFrame {
    ...
    private void initUI() throws FileNotFoundException {
        ...
        final Surface surface = new Surface(GameStage.load("C:\\Users\\ASUS\\Desktop\\gam\\The Game\\src\\demo.txt"));
        add(surface);
